<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <div class="note-table-set-container">
    <div class="note-table-set-wrap">
      <div v-if="!stepIndex" class="note-table">
        <table-page-section
          type="note"
      ...
      <div v-else class="note-set">
        <form-set-section
          type="note"
          :title="'短信素材库 / ' + (form.id ? '编辑' : '新增')"
          :form="form"
          :rules="rules"
          :material-fn-data="materialFnData"
          @tabStepAction="tabStepAction"
        >
          <template v-slot:default>
            <el-form-item label="短信内容：" prop="content">
              <el-row type="flex" class="note-rule clearfix">
...
export default {
  ...
  methods: {
    ...
    getSponsorMaterialTemplateList() {
      materialList({ ...this.pageData, type: materialTypeData.note, sponsorId: this.materialForm.sponsor }).then(response => {
